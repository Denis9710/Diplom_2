...
class TestCreateOrder:
    ...
    @allure.title("Создание заказа с авторизацией - успех 200")
    ...
    @allure.title("Создание заказа без авторизации - успех 200")
    ...
    @allure.title("Создание заказа с ингредиентами - успех 200")
    ...
    def test_create_order_without_ingredients_error_400(self, api_client, authorized_user_success):
